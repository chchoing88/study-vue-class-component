<template>
  <p>
    ...
    <button @click="emitTest1(2019)">클릭 </button>
...
export default class Test extends Vue {
  ...
  @Emit('emit-test-one') // 이벤트의 이름만 알려주는 것이다. 인자에 들어가는 문자열은 
  // emitTest1() {} // this.$emit('emit-test1');
  emitTest1(year: number) {
    this.person.age++ // 어떤 행동을 하고 emit을 처리할때..
    return 1983
